...
multi
ggsave("../figures/taxa-bar-phyum-genus-MSM-microshades.pdf",plot=multi,height=10,width=10)
...
multi <- plot_grid(plot_1, GP_legend,  rel_widths = c(1, .25))
multi
ggsave("../figures/taxa-bar-phyum-species-expanded-prev-MSM-microshades.pdf",plot=multi,height=6,width=10)
```
