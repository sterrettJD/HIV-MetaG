...
## Prevotella ~ expected (from 16S)
```{r}

ggplot(data=prev.stats,
       mapping=aes(y=Prevotella, x=expected_Prevotella)) +
    geom_point() + 
    geom_smooth(method="lm") +
    xlab("Expected % Prevotella from 16S") +
    theme_bw()  

summary(lm(Prevotella ~ expected_Prevotella, data=prev.stats))
```
