...
rule profile_panphlan_p_copri:
    ...
    output:
        MATRIX="hiv.t32.p_copri_panphlan_prof/gene_presence_absence_{ANNOT_FIELD}.tsv",
        COV="hiv.t32.p_copri_panphlan_prof/gene_coverage_{ANNOT_FIELD}.tsv"
    resources:
        partition="short",
        mem_mb=int(4*1000), # MB, or 4 GB
        runtime=int(1*60) # min, or 1 hour
    ...
    shell:
        """
        mkdir -p hiv.t32.p_copri_panphlan_prof/
